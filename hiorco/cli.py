...
def main():
    ...
    parser.add_argument('-o', '--output', default=".", dest='output folder', help="Output folder (optional).")
    ...
    data = pd.read_csv(args.data, sep=args.sep)

    compute(data,
        k=args.k,
        n=args.n,
        p=args.p,
        abundance_cutoff=args.cutoff,
